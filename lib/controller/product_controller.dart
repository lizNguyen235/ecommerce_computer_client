...
//       final list = await _repo.getFeaturedProducts(limit: 8);
...
//       final list = await _repo.getNewProducts(limit: 8);
...
//       final list = await _repo.getAllProductsSimple(limit: 8);
...
//
//   // Utilities
//   double calculateSalePercentage(double price, double salePrice) {
//     if (price <= 0) return 0;
